      ...
      <header className="text-center mb-18">
        ...
        <nav className="flex gap-4 justify-center">
          <a
            ...
            target="_blank"
            className="flex shadow-xs items-center justify-center gap-2 border-gray-300/60 border cursor-pointer rounded-md py-2 px-3 hover:bg-neutral-50 transition-all"
          >
            <svg
              width="16"
              height="16"
          ...
          <div className="space-y-2">
            ...
            <table className="w-full text-sm border border-gray-200 rounded-md overflow-hidden">
              ...
              <tbody>
                ...
                <tr className="border-b border-gray-100 last:border-0">
                  <td className="px-3 py-2.5 text-stone-600">ZIP code (US)</td>
                  <td className="px-3 py-2.5 text-stone-600 font-mono text-xs">
                    99999
                  </td>
                  <td className="px-3 py-2.5 text-stone-600 font-mono text-xs">
